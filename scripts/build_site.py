...
GAMES = [
    ...
    dict(name='Liar’s Dice / Perudo', slug='liars-dice', players='3–6 ideal', player_tags=['3+ Players'], dice='5 dice per player', time='15–30 min', complexity='Easy', vibe='Bluffing and table talk', tags=['Dice','3+ Players','Bluffing','Party','Dice Cups','Additional Items Required'], needs=['5 dice per player','Opaque dice cup per player'], printables=['Rules reference'], status='Playable; optional advanced wilds'),
    ...
    dict(name='Mia', slug='mia', players='3+ players', player_tags=['3+ Players'], dice='2 dice', time='5–15 min', complexity='Easy', vibe='Tiny bluffing game', tags=['Dice','3+ Players','Bluffing','Pub Game','Dice Cups','Additional Items Required'], needs=['2 dice','One opaque cup'], printables=['Rules reference'], status='Needs house-rule cleanup'),
    ...
    dict(name='Skunk', slug='skunk', players='3+ ideal; 2 works', player_tags=['2 Players','3+ Players'], dice='2 dice', time='10–20 min', complexity='Easy', vibe='Group push your luck', tags=['Dice','2 Players','3+ Players','Push Your Luck','Family Friendly','Scoresheet PDF'], needs=['2 dice','Score sheet','Pen or pencil'], printables=['Scoresheet PDF'], status='Needs house-rule cleanup'),
    dict(name='Midnight', slug='midnight', players='2+ players', player_tags=['2 Players','3+ Players'], dice='6 dice', time='5–15 min', complexity='Easy', vibe='Quick pub game', tags=['Dice','2 Players','3+ Players','Pub Game','Quick','Easy'], needs=['6 dice','Optional score sheet'], printables=['Scoresheet PDF'], status='Needs house-rule cleanup'),
